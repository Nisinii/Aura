        ...
        <div className="w-full px-6 md:px-12 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:flex gap-6 text-sm font-bold">
              ...
              <Link href="/dashboard/doctor/search" className="text-zinc-400 hover:text-white transition-colors">Find Patient</Link>
            </div>

            <div className="w-px h-8 bg-white/10 hidden md:block"></div>

            <div className="flex items-center gap-4">
              <Link href="/dashboard/doctor/notifications" className="relative group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {patients.map((patient) => (
            ...
            >
              ...
              <Link 
                href={`/doctor/analytics/${patient.id}`} 
